#!/bin/bash
#
# @file hive/ranger2-client.sh
# @brief Provides function to install Apache Ranger-2.0.0 client for Hive

source /usr/lib/qubole/bootstrap-functions/common/utils.sh
source /usr/lib/qubole/bootstrap-functions/hive/hiveserver2.sh

# @description Install Apache Ranger-2.0.0 client for Hive
#
